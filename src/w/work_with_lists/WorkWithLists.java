...
//    wow! Well done! you are monster
//
//Congratulations! You have improved the best code complexity for this step, your score is 40.15 (less is better).
//https://stepik.org/lesson/40272/step/1?adaptive=true&discussion=569724&thread=solutions&unit=24612
    public static void main(String[] args) throws IOException {
        BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
        String allElements = reader.readLine();
        List<Integer> bigList = Arrays.stream(allElements.split(" "))
